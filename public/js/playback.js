...
var Vibes = {
    ...
    routes: {
        ...
        'addTrack': function addTrack(vibeID, trapApiId, category) {
            return '/track-vibe/vibe/' + vibeID + '/track-api/' + trapApiId + '/category/' + category;
        },

        'pendDetachTrack': function pendDetachTrack(vibeID, trackID) {
            return '/pending-vibe-track-detach/vibe/' + vibeID + '/track/' + trackID;
        },
        'pendAttachTrack': function pendAttachTrack(vibeID, trapApiId) {
            return '/pending-vibe-track-attach/vibe/' + vibeID + '/track-api/' + trapApiId;
        },
        'cancelPendingAttachTrack': function cancelPendingAttachTrack(pendingTrackID) {
            return '/pending-vibe-track-attach/delete/' + pendingTrackID;
        },
        'cancelPendingDetachTrack': function cancelPendingDetachTrack(pendingTrackID) {
        ...
        'sendPendingTracksToAttachResponses': function sendPendingTracksToAttachResponses(vibeID) {
            return '/pending-vibe-tracks-attach/respond/vibe/' + vibeID;
        },
        'sendPendingTracksToDetachResponses': function sendPendingTracksToDetachResponses(vibeID) {
    ...
    getAll: function getAll() {
        ...
        return new Promise(function (resolve, reject) {
            return axios.get(_this.routes.index).then(function (response) {
                ...
                _this.setPendingTracksResponsesData();
                _this.updateShowData();
                _this.sortVibesOrder();
                _this.loading = false;
                resolve(vibesData);
    ...
    create: function create(form) {
        ...
        return new Promise(function (resolve, reject) {
            return form.post(_this2.routes.create).then(function (response) {
                var vibe = response.vibe;

                _this2.playingTracks[vibe.id] = null;
                _this2.pendingTracksToAttachResponses[vibe.id] = { 'accepted': [], 'rejected': [] };
                _this2.pendingTracksToDetachResponses[vibe.id] = { 'accepted': [], 'rejected': [] };

                _this2.all.push(vibe);
                _this2.sortVibesOrder();

                _this2.user.addVibeToVibesIDs(vibe);
                resolve(vibe);
            }).catch(function (error) {
                reject(error.response.data.errors);
            });
    ...
    update: function update(form, vibeID) {
        ...
        return new Promise(function (resolve, reject) {
            return form.update(_this4.routes.update(vibeID)).then(function (response) {
    ...
    delete: function _delete(form, vibeID) {
        ...
        form.delete(this.routes.delete(vibeID)).then(function () {
            _this5.deleted.push(_this5.all.find(function (vibe) {
                return vibe.id === vibeID;
            }));
            _this5.removeVibeFromAllVibesAndTracksData(vibeID);
            _this5.user.removeVibeFromVibesIDs(vibeID);
            _this5.show = {};
    ...
    joinVibe: function joinVibe(form, vibeID) {
        ...
        form.post(this.routes.joinVibe(vibeID)).then(function (response) {
            ...
            _this13.sortVibesOrder();
            _this13.user.addVibeToVibesIDs(response.vibe);
        }).catch(function (errors) {
            return console.log(errors);
        });
    },
    ...
    leaveVibe: function leaveVibe(form, vibeID) {
        ...
        form.delete(this.routes.leaveVibe(vibeID)).then(function (response) {
            ...
            _this14.user.removeVibeFromVibesIDs(vibeID);
        }).catch(function (errors) {
            return console.log(errors);
        });
    },
    ...
    addTrack: function addTrack(form, vibeID, trackApiId, category) {
        var _this16 = this;

        form.post(this.routes.addTrack(vibeID, trackApiId, category)).then(function (response) {
            _this16.updateTrackData(response, _this16.addVibeToTrackVibes);
    ...
    removeTrack: function removeTrack(form, vibeID, trackID) {
        ...
        form.delete(this.routes.removeTrack(vibeID, trackID)).then(function (response) {
            _this17.updateTrackData(response, _this17.removeVibeFromTrackVibes);
    ...
    pendAttachTrack: function pendAttachTrack(form, vibeID, trackApiId) {
        var _this18 = this;

        form.post(this.routes.pendAttachTrack(vibeID, trackApiId)).then(function (response) {
            _this18.updateTrackData(response, _this18.addVibeToTrackPendingVibesToAttach);
    ...
    cancelPendingAttachTrack: function cancelPendingAttachTrack(form, pendingTrack) {
        var _this19 = this;

        form.delete(this.routes.cancelPendingAttachTrack(pendingTrack.id)).then(function (response) {
            _this19.updateTrackData(response, _this19.removeVibeFromTrackPendingVibesToAttach);
    ...
    pendDetachTrack: function pendDetachTrack(form, vibeID, trackID) {
        var _this20 = this;

        form.post(this.routes.pendDetachTrack(vibeID, trackID)).then(function (response) {
            _this20.updateTrackData(response, _this20.addVibeToTrackPendingVibesToDetach);
            _this20.updateShowData();
        }).catch(function (errors) {
            return console.log(errors);
        });
    },

    cancelPendingDetachTrack: function cancelPendingDetachTrack(form, pendingTrack) {
        var _this21 = this;

        form.delete(this.routes.cancelPendingDetachTrack(pendingTrack.id)).then(function (response) {
            _this21.updateTrackData(response, _this21.removeVibeFromTrackPendingVibesToDetach);
            _this21.updateShowData();
        }).catch(function (errors) {
            return console.log(errors);
        });
    },

    sendPendingTracksToAttachResponses: function sendPendingTracksToAttachResponses(form, vibeID) {
        var _this22 = this;

        form.constructor(this.pendingTracksToAttachResponses[vibeID]);
        form.post(this.routes.sendPendingTracksToAttachResponses(vibeID)).then(function (response) {
            _this22.updateTracksForResponseToPendingTracks(response.vibe, _this22.pendingTracksToAttachResponses[vibeID], _this22.addVibeToTrackVibes, _this22.removeVibeFromTrackPendingVibesToAttach);
            _this22.updateShowData();
            _this22.resetPendingTracksToAttachResponsesData(vibeID);
        }).catch(function (errors) {
            return console.log(errors);
        });
    },
    sendPendingTracksToDetachResponses: function sendPendingTracksToDetachResponses(form, vibeID) {
        var _this23 = this;

        form.constructor(this.pendingTracksToDetachResponses[vibeID]);
        form.post(this.routes.sendPendingTracksToDetachResponses(vibeID)).then(function (response) {
            _this23.updateTracksForResponseToPendingTracks(response.vibe, _this23.pendingTracksToDetachResponses[vibeID], _this23.removeVibeFromTrackVibes, _this23.removeVibeFromTrackPendingVibesToDetach);
            _this23.updateShowData();
            _this23.resetPendingTracksToDetachResponsesData(vibeID);
        }).catch(function (errors) {
            return console.log(errors);
        });
    },
    ...
    downvoteTrack: function downvoteTrack(form, vibeID, trackID) {
        ...
        form.delete(this.routes.downvoteTrack(vibeID, trackID)).then(function (response) {
            _this25.updateData(response);
        }).catch(function (errors) {
            return console.log(errors);
        });
    },

    addVibeToTrackVibes: function addVibeToTrackVibes(vibeID, track) {
        track.vibes.push(vibeID);
    },
    addVibeToTrackPendingVibesToAttach: function addVibeToTrackPendingVibesToAttach(vibeID, track) {
        track.pending_vibes_to_attach.push(vibeID);
    },
    addVibeToTrackPendingVibesToDetach: function addVibeToTrackPendingVibesToDetach(vibeID, track) {
        track.pending_vibes_to_detach.push(vibeID);
    },
    removeVibeFromTrackVibes: function removeVibeFromTrackVibes(vibeID, track) {
        var trackVibeIndex = track.vibes.indexOf(vibeID);
        if (trackVibeIndex !== -1) {
            track.vibes.splice(trackVibeIndex, 1);
        }
    },
    removeVibeFromTrackPendingVibesToAttach: function removeVibeFromTrackPendingVibesToAttach(vibeID, track) {
        var pendingVibeTrackIndex = track.pending_vibes_to_attach.indexOf(vibeID);
        if (pendingVibeTrackIndex !== -1) {
            track.pending_vibes_to_attach.splice(pendingVibeTrackIndex, 1);
        }
    },
    removeVibeFromTrackPendingVibesToDetach: function removeVibeFromTrackPendingVibesToDetach(vibeID, track) {
        var pendingVibeTrackIndex = track.pending_vibes_to_detach.indexOf(vibeID);
        if (pendingVibeTrackIndex !== -1) {
            track.pending_vibes_to_detach.splice(pendingVibeTrackIndex, 1);
        }
    },
    updateTrackData: function updateTrackData(response, action) {
        this.all = this.all.map(function (vibe) {
            if (!vibe.auto_jd) {
                for (var key in vibe.api_tracks) {
                    if (vibe.api_tracks.hasOwnProperty(key)) {
                        vibe.api_tracks[key].forEach(function (track) {
    ...
    updateTracksForResponseToPendingTracks: function updateTracksForResponseToPendingTracks(responseVibe, responses, acceptedAction, respondedAction) {
        var acceptedTracksIDs = responses.accepted;
        var rejectedTracksIDs = responses.rejected;
        var respondedTracksIDs = [].concat(_toConsumableArray(acceptedTracksIDs), _toConsumableArray(rejectedTracksIDs));
    ...
    removeVibeFromAllVibesAndTracksData: function removeVibeFromAllVibesAndTracksData(vibeID) {
        var _this26 = this;

        this.all = this.all.filter(function (vibe) {
            return vibe.id !== vibeID;
        }).map(function (vibe) {
            for (var key in vibe.api_tracks) {
                if (vibe.api_tracks.hasOwnProperty(key)) {
                    vibe.api_tracks[key].forEach(function (track) {
                        _this26.removeVibeFromTrackVibes(vibe.id, track);
                        _this26.removeVibeFromTrackPendingVibesToAttach(vibe.id, track);
                        _this26.removeVibeFromTrackPendingVibesToDetach(vibe.id, track);
                    });
                }
            }
            return vibe;
    ...
    updateShowData: function updateShowData() {
        ...
        this.show = this.all.find(function (vibe) {
            return vibe.id === _this27.showID;
        });
    },
    ...
    setPendingTracksResponsesData: function setPendingTracksResponsesData() {
        var _this28 = this;

        this.all.forEach(function (vibe) {
            _this28.pendingTracksToAttachResponses[vibe.id] = { 'accepted': [], 'rejected': [] };
            _this28.pendingTracksToDetachResponses[vibe.id] = { 'accepted': [], 'rejected': [] };
        });
    },
    resetPendingTracksToAttachResponsesData: function resetPendingTracksToAttachResponsesData(vibeID) {
        for (var key in this.pendingTracksToAttachResponses[vibeID].accepted) {
        ...
        for (var _key in this.pendingTracksToAttachResponses[vibeID].rejected) {
            if (this.pendingTracksToAttachResponses[vibeID].rejected.hasOwnProperty(_key)) {
                this.pendingTracksToAttachResponses[vibeID].rejected.splice(_key, 1);
            }
        }
    },
    resetPendingTracksToDetachResponsesData: function resetPendingTracksToDetachResponsesData(vibeID) {
        for (var key in this.pendingTracksToDetachResponses[vibeID].accepted) {
        ...
        for (var _key2 in this.pendingTracksToDetachResponses[vibeID].rejected) {
            if (this.pendingTracksToDetachResponses[vibeID].rejected.hasOwnProperty(_key2)) {
                this.pendingTracksToDetachResponses[vibeID].rejected.splice(_key2, 1);
            }
        }
    },
    updateData: function updateData(response) {
        ...
        this.all = this.all.map(function (vibe) {
            if (vibe.id === response.vibe.id) {
                _this29.show = response.vibe;
                _this29.message = response.message;
                setTimeout(function () {
                    return _this29.message = '';
                }, 20000);
                return response.vibe;
            }
            return vibe;
    ...
    sortVibesOrder: function sortVibesOrder() {
        var _this30 = this;

        var vibesNames = this.all.map(function (vibe) {
            return vibe.name;
        });
        vibesNames.sort();
        this.all = vibesNames.map(function (name) {
            return _this30.all.find(function (vibe) {
                return vibe.name === name;
            });
        });
    ...
    ownedByUser: function ownedByUser(vibeID) {
        var vibe = this.all.filter(function (vibe) {
            return vibe.id === vibeID;
        })[0];
...
var Search = {
    ...
    searchInput: __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.debounce(function (input) {
        var _this = this;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vibes__ = __webpack_require__(0);
...
var playback = {
    ...
    playPlaylist: function playPlaylist(_ref) {
    ...
    updateSearchPlayingTrack: function updateSearchPlayingTrack(trackID) {
        this.search.playingTrack = trackID;
    },
    updateVibePlayingTrack: function updateVibePlayingTrack(trackID) {
        var _this = this;

        var vibe = this.vibes.all.filter(function (vibe) {
            return vibe.id === _this.vibeID;
        })[0];
    ...
    broadcastVibePlayingTrack: function broadcastVibePlayingTrack(trackID) {
    ...
    vibePlayingTrackBroadcastDataIsNotDifferent: function vibePlayingTrackBroadcastDataIsNotDifferent(trackID) {
        if (this.vibePlayingTrackBroadcastDataHasRightKeysSet()) {
            return this.vibePlayingTrackBroadcastData['track_id'] === trackID && this.vibePlayingTrackBroadcastData['vibe_id'] === this.vibeID && this.vibePlayingTrackBroadcastData['is_track_paused'] === this.paused && this.vibePlayingTrackBroadcastData['type'] === this.type;
        }

        return false;
    },
    vibePlayingTrackBroadcastDataHasRightKeysSet: function vibePlayingTrackBroadcastDataHasRightKeysSet() {
        return this.vibePlayingTrackBroadcastData.hasOwnProperty('vibe_id') && this.vibePlayingTrackBroadcastData.hasOwnProperty('track_id') && this.vibePlayingTrackBroadcastData.hasOwnProperty('is_track_paused') && this.vibePlayingTrackBroadcastData.hasOwnProperty('type');
    },


    sendBroadcastDataToServer: __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.debounce(function (trackID) {
        ...
        axios.post(this.routes.broadcast, this.vibePlayingTrackBroadcastData).then(function (response) {}).catch(function (error) {
